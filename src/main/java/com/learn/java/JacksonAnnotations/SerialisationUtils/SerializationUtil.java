package com.learn.java.JacksonAnnotations.SerialisationUtils;
...
public class SerializationUtil {
  ...
  public static ObjectMapper mapper() {
    Preconditions.checkNotNull(objectMapper,
        "Please call SerialisationUtil.init(mapper) to set mapper");
    return objectMapper;
  }
  ...
  /**
   * 1. For converting json string to class type use readValue 2. For converting object type to
   * class type use convertValue
   */
